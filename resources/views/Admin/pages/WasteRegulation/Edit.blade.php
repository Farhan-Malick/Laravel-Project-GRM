                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form action="{{ URL('/Admin/Waste-Update') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input value="{{ $waste['id'] }}" type="hidden" name="id">
                                            <div class="card-body">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="link1" class="form-control"
                                                            value="{{ $waste['link1'] }}" id="exampleInputTitle"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="link2" class="form-control"
                                                            value="{{ $waste['link2'] }}" id="exampleInputTitle"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="link3" class="form-control"
                                                            value="{{ $waste['link3'] }}" id="exampleInputTitle"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="link4" class="form-control"
                                                            value="{{ $waste['link4'] }}" id="exampleInputTitle"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input value="{{ $waste['link5'] }}" type="text" name="link5"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input value="{{ $waste['link6'] }}" type="text" name="link6"
                                                            class="form-control" id="exampleInputTitle"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input value="{{ $waste['link7'] }}" type="text" name="link7"
                                                            class="form-control" id="exampleInputTitle"
                                                            placeholder="Enter Link 7 ">
                                                        @error('link7')
                                                            <span>{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input value="{{ $waste['link8'] }}" type="text" name="link8"
                                                            class="form-control" id="exampleInputTitle"
                                                            placeholder="Enter Link 8 ">
                                                        @error('link8')
                                                            <span>{{ $message }}</span>
                                                        @enderror
                                                    </div>
