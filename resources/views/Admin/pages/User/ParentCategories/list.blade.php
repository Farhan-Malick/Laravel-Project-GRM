                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-success" href="{{ URL('/Admin/Add_Category') }}">Add
                                            Post</a>
                                    </div>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            @if ($categories->category_id)
                                                                <b>{{ $categories->parent->category }}</b>
                                                            @else
                                                                <b>Main Category</b>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary"
                                                                href="{{ URL('/Admin/Category_Edit/' . $categories->id) }}">Edit</a>
                                                            <a class="btn btn-danger"
                                                                href="{{ URL('/Admin/Category/' . $categories->id) }}">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
