                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title text-lg float-left col-md-12">
                                            ...
                                            <a class="float-right btn btn-danger"
                                                href="{{ URL('/Admin/Request_Category-List') }}">Back</a>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 border 1px">
                                                <form action="{{ route('category.stores') }}" method="POST"
                                                    class="pb-2" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="card-body">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for=""><b>Sub-Category Of :</b> </label>
