...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            ...
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">Add Something In Tenders <small>You Can Update And Delete Data</small></h1>
            <!-- end page-header -->

            <!-- begin panel -->
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">GRM Add Data Tenders Section</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form action="{{ URL('/Admin/Tender') }}" method="POST"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="date" name="odate" class="form-control"
                                                            id="exampleInputTitle" placeholder="Enter Opening Date">
                                                        @error('odate')
                                                            <span>{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="date" name="cdate" class="form-control"
                                                            id="exampleInputTitle" placeholder="Enter Closing Date">
                                                        @error('cdate')
                                                            <span>{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="amount" class="form-control"
                                                            id="exampleInputTitle" placeholder="Enter Amount ">
                                                        @error('amount')
                                                            <span>{{ $message }}</span>
                                                        @enderror
                                                    </div>
