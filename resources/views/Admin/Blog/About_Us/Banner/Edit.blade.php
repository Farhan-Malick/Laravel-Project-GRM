                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title text-lg float-left col-md-12">
                                            ...
                                            <a class="float-right btn btn-danger"
                                                href="{{ URL('/Admin/AboutUsBanner') }}">Back</a>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                        value="{{ $AboutUsBanner['title'] }}" id="exampleInputTitle"
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <img class=""
                                                            src="{{ asset('storage/app/public/post/AboutUs/BannerImage1/' . $AboutUsBanner->image) }}"
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <img class=""
                                                            src="{{ asset('storage/app/public/post/AboutUs/BannerImage2/' . $AboutUsBanner->image2) }}"
                                                            width="80px" alt="" height="35px">
