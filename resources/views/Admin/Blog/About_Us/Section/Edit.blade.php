                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form action="{{ URL('/Admin/Section-Update') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $AboutUsSection['id'] }}">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for=""><b>Heading</b> </label>
                                                    <input type="text" name="heading" class="form-control"
                                                        value="{{ $AboutUsSection['heading'] }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                        value="{{ $AboutUsSection['title'] }}" id="exampleInputTitle"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="{{ $AboutUsSection['p1'] }}"
                                                            name="p1" class="form-control" id="exampleInputp1"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="p2" class="form-control"
                                                            value="{{ $AboutUsSection['p2'] }}" id="exampleInputp2"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="p3"
                                                            value="{{ $AboutUsSection['p3'] }}"
                                                            class="form-control" id="exampleInputp3"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input value="{{ $AboutUsSection['p4'] }}" type="text"
                                                            name="p4" class="form-control" id="exampleInputp4"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="p5" class="form-control"
                                                            value="{{ $AboutUsSection['p5'] }}" id="exampleInputp5"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="p6" class="form-control"
                                                            value="{{ $AboutUsSection['p6'] }}" id="exampleInputp6"
                                                            placeholder="Enter Paragraph 6 ">
                                                        @error('p6')
                                                            <span>{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-6">
                                                        ...
                                                        <div class="img mt-3">
                                                            <img class=""
                                                                src="{{ asset('storage/app/public/post/AboutUs/SectionImage/' . $AboutUsSection->image) }}"
                                                                width="100%" alt="" height="500px">
                                                        </div>
                                                        @error('image')
                                                            <span>{{ $message }}</span>
                                                        @enderror
