                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-success" href="{{ route('/Admin/RecyclingKC') }}">Add
                                            Post</a>
                                    </div>
                                    @if (session('msg'))
                                    ...
                                    <div class="card-body">
                                        <table id="data-table-default"
                                            ...
                                            <tbody>
                                                @foreach ($RecyclingKC as $headers)
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary"
                                                                href="{{ URL('/Admin/RecyclingKC-Edit/' . $headers->id) }}">Edit</a>
                                                            <a class="btn btn-danger"
                                                                href="{{ URL('/Admin/RecyclingKC/' . $headers->id) }}">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
