                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form action="{{ URL('/Admin/GRM-Update') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $WhyUseGRM['id'] }}">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for=""><b>Heading</b> </label>
                                                    <input type="text" name="heading" class="form-control"
                                                        value="{{ $WhyUseGRM['heading'] }}" id=" exampleInputTitle"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="{{ $WhyUseGRM['p1'] }}" name="p1"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="p2" class="form-control"
                                                            value="{{ $WhyUseGRM['p2'] }}" id="exampleInputp2"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="p3" value="{{ $WhyUseGRM['p3'] }}"
