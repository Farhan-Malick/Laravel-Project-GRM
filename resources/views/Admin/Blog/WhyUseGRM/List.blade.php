                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a class="btn btn-success" href="{{ route('/Admin/Why-Use-GRM') }}">Add
                                            Post</a>
                                    </div>
                                    @if (session('msg'))
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary"
                                                                href="{{ URL('/Admin/GRM-Edit/' . $headers->id) }}">Edit</a>
                                                            <a class="btn btn-danger"
                                                                href="{{ URL('/Admin/Why-Use-GRM/' . $headers->id) }}">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
