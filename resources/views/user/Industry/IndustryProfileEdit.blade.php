...
<body>
    ...
    <div class="container mt-3 mb-3  border 1px">
        <form action="{{ URL('/Update-industry-Data') }}" method="POST" enctype="multipart/form-data"
            class="reg_para">
            @csrf
            <input value="{{ $industryData['id'] }}" type="hidden" name="id">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="row ">
                        <div class="col-md-12 ">
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12">
                                    ...
                                    <input type="text" value="{{ $industryData['name'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12  ">
                                    ...
                                    <input type="email" value="{{ $industryData->company_email }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12  ">
                                    ...
                                    <input type="tel" value="{{ $industryData['phone'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12  ">
                                    ...
                                    <input type="text" value="{{ $industryData['company_website'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12  ">
                                    ...
                                    <input type="text" value="{{ $industryData['description'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12  ">
                                    ...
                                    <input type="text" value="{{ $industryData['companyfy'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12">
                                    ...
                                    <textarea type="text" name="address" id="" cols="30" rows="1"
                                        ...
                                        placeholder="Enter Company Address ">{{ $industryData->address }}</textarea>
                                    @error('address')
                                        <span>{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-12">
                                    ...
                                    <textarea type="text" name="warehouse" id="" cols="30" rows="1"
                                        ...
                                        placeholder="Enter Warehouse Address ">{{ $industryData->warehouse }}</textarea>
                                    @error('warehouse')
                                        <span>{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="tel" value="{{ $industryData['vat_id'] }}"
                                ...
                                <div class="form-group  col-md-6  ">
                                    ...
                                    <input type="tel" value="{{ $industryData['tax_id'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="tel" value="{{ $industryData['reg_id'] }}"
                                ...
                                <div class="form-group  col-md-6  ">
                                    ...
                                    <input type="text" value="{{ $industryData['court'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="text" value="{{ $industryData['linkedin'] }}"
                                ...
                                <div class="form-group  col-md-6  ">
                                    ...
                                    <input type="text" value="{{ $industryData['facebook'] }}"
                            ...
                            <div class="form-row ">
                                <div class="form-group  col-md-6">
                                    ...
                                    <input type="text" value="{{ $industryData['twitter'] }}"
                                ...
                                <div class="form-group  col-md-6  ">
                                    ...
                                    <input type="text" value="{{ $industryData['insta'] }}"
                            ...
                            <div class="form-row">
                                <div class="ml-2">
                                    <img class=""
                                        src="{{ asset('storage/app/public/post/Memberships/' . $industryData->image) }}"
