...
<body>
    ...
    <form action="{{ URL('/Industry-Portfolio') }}" method="POST" enctype="multipart/form-data"
        class="reg_para">
        @csrf
                ...
                @foreach ($medias as $medi)
                    <div class="col-md-3  d-flex ">
                        <div class="" style="float: left">
                            <img src="{{ asset('storage/app/public/post/industryPortfolio/' . $medi->file) }}"
                                height="200px" width="100%" class="mt-2 mb-2" />
                        </div>
                    </div>
                @endforeach
            </div>
            ...
            <div class="row ">
                @foreach ($medias as $medi)
                    <div class="col-md-2  d-flex ">
                        <div class="" style="float: left">
                            <video src="{{ asset('storage/app/public/post/industryPortfolio/' . $medi->video) }}"
                                type="video/webm" height="300px" width="100%"></video>
                        </div>
                    </div>
                @endforeach
            </div>
