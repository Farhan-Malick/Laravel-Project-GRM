        ...
        <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="border 1px p-4 reg_para">
                    <form action="{{ URL('/Add-Industry-Services') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="">
                            <div class="form-row">
                                <div class="form-group   col-md-6  ">
                                    <label class="reg_para" for="">Service Providers :
                                        <small>(Select industry that you have selected from Membership/Subscription
                                            Form)</small></label>
                                    <select name="service_id"
                                        class="form-control  @error('service_id') is-invalid @enderror reg_para mt-1 Drop">
                                        <option name="">--</option>
                                        @foreach ($ServiceProviders as $industry)
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="services_type" class="form-control"
                                        id="exampleInputTitle" placeholder="Enter Services Type">
                                    @error('services_type')
                                        <span>{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="duration" class="form-control" id="exampleInputTitle"
