    ...
    <div class="container border 1px reg_para">
        <div class="row pb-1">
            ...
            <div class="col-md-7 mb-2 border-left 1px pt-3">
                ...
                @if ($industryData)
                    <a href="{{ URL('Edit-Industry-Data/' . $industryData->id) }}" type="submit"
        ...
        @if (!$industryData)
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="{{ url('/Add_Industry_Data ') }}" type="submit"
                        class="btn btn-success pb-0 pb-2 mt-1 reg_para mb-2" style="float: right">
                        Add Industry Data
                    </a>
                </div>
            </div>
                                            ...
                                            <div class="mt-3">
                                                <div class=" custom-file">
                                                    <label><b>
                                                        ...
                                                        <br>
                                                        @foreach ($MembershipForm as $item)
