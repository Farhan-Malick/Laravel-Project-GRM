            ...
            <div class="col-md-12 col-lg-9 col-12">
                <section id="team" class="pb-5">
                    <div class="container">
                        <div class="row">
                            <!-- Team member -->
                            @foreach ($AddRequest as $u_ads)
                                <div class="col-lg-4 col-md-6 col-12 content mt-2" id="jar">
                                                ...
                                                <div class="card">
                                                    <div class="card-body text-center">
                                                        <p><img class=" img-fluid"
                                                                src="{{ asset('public/assets/images/abt2.jpg') }}"
                                                                alt="card image"></p>
                                                        <h5 class="card-title">
                                                            {{ $u_ads->mtype->category }} <br>
                                                            {{ $u_ads->Add_Request->category }}<br>
                                                            {{ $u_ads->weight }}
                                                        </h5>
                                                        <p class="card-text">
                                                            {{ Str::limit($u_ads->condition, 70) }}<br>
                                                            <b>( {{ $u_ads->location }} )</b>
                                                        </p>
                                                        <div class="">
                                                            <div class="text-center ">
                                                                <a href="{{ url('Request-Details/' . $u_ads->id) }}"
