...
<body>
    ...
    <div class="container-fluid trade2 p-5 mt-4 mb-4" id="jar">
        <div class="row">
            <div class="col-md-12">
                <h2 class="trade2">General Ads Store</h2>
                <hr class="bg-success">
            </div>
        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {{-- <input type="checkbox" name="filterbrand" value="" id=""> DEMO --}}
                                            @foreach ($categories as $item)
                                                @if ($item->childs->count() > null)
                                                    <p class="trade2 reg_para mb-2">{{ $item->category }}
                                                    </p>
                                                    <select id="{{ $item->id }}" name="sub_category[]"
                                                        ...
                                                        @foreach ($item->childs as $sub_category)
                                                            ...
                                                            @endphp
                                                            <option value="{{ $sub_category->category }}">
                                                ...
                                                <div class="card">
                                                    <div class="card-body text-center">
                                                        <p><img class=" img-fluid"
                                                                src="{{ asset('storage/app/public/post/usersAd1/' . $u_ads->image1) }}"
                                                                alt="card image"></p>
                                                        <h4 class="card-title">
                                                            {{ $u_ads->Client_ads_cat->category }} <br>
                                                            {{ $u_ads->location }},{{ $u_ads->country }}
                                                        </h4>
                                                        <p class="card-text">
                                                            {{ Str::limit($u_ads->description, 70) }}</p>
                                            ...
                                            <div class="backside">
                                                <div class="card">
                                                    <div class="card-body text-center mt-4">
                                                        <h4 class="card-title">{{ $u_ads->title }}
                                                            <br>
                                                            {{ $u_ads->Client_ads_cat->category }} <br>
                                                        </h4>
                                                        <p class="card-text">
                                                            {{ Str::limit($u_ads->description, 150) }}
                                                        </p>
                                                        <a href="{{ url('Ad-view/' . $u_ads->id) }}"
