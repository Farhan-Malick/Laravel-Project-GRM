...
<body>
    ...
    <div class="container A_P mt-2 mb-5">
        <form action="{{ URL('/Req-Update') }}" method="POST" enctype="multipart/form-data" class="reg_para">
            @csrf
            <input value="{{ $addreq['id'] }}" type="hidden" name="id">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="col-md-12 pl-5 pr-5">
                        <div class="form-row ">
                            <div class="form-group  col-md-12  ">
                                ...
                                <input value="{{ $addreq['p_name'] }}" type="text" class="form-control reg_para "
                                    name="p_name" require placeholder="Enter Product Name" required>
                            </div>
                        </div>
                        <div class="form-row ">
                            <div class="form-group  col-md-12">
                        ...
                        <div class="form-row">
                            <div class="form-group   col-md-12  ">
                                ...
                                <select name="location" required class="form-control reg_para ">
                        ...
                        <div class="form-row ">
                            <div class="form-group  col-md-12  ">
                                ...
                                <input value="{{ $addreq['weight'] }}" type="text" class="form-control reg_para "
                                    name="weight" require placeholder="Weight Must be in KG'S, MT (Metric Tonnes), LB"
                                    required>
                            </div>
                        </div>
                        <div class="row">
