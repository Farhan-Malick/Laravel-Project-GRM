                            ...
                            <div class="col-md-12 pl-5 pr-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="Description"
                                        aria-describedby="DescriptionHelp" cols="30" rows="4">
                            ...
                            <div class="col-md-12 pl-5 pr-5">
                                <div class="form-row ">
                                    <div class="form-group   col-md-12  ">
                                        ...
                                        <select name="p_terms" value="{{ old('p_terms') }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group   col-md-6  ">
                                        ...
                                        <p> <small>(Without Product Weight
                                                ...
                                                Go Any
                                                Further)</small></p>
                                        <select name="unit_weight" value="{{ old('unit_weight') }}"
                                ...
                                <div class="form-row ">
                                    <div class="form-group   col-md-4  ">
                                        ...
                                        <select name="supply_type" value="{{ old('supply_type') }}"
                                    ...
                                    <div class="form-group  col-md-4  ">
                                        ...
                                        <input type="text" value="{{ old('currency') }}"
                                    ...
                                    <div class="form-group   col-md-4  ">
                                        ...
                                        <input type="number" placeholder="Rs" value="{{ old('price') }}"
                                    ...
                                    <div class="form-group col-md-12  ">
                                        ...
                                        <input type="text" value="{{ old('quantity_avl') }}"
                            ...
                            <div class="col-md-12 pl-5 pr-5">
                                <div class="form-row ">
                                    <div class="form-group  col-md-12  ">
                                        ...
                                        <input type="text" value="{{ old('col_address') }}"
                                ...
                                <div class="form-row ">
                                    ...
                                    <div class="form-group   col-md-4  ">
                                        ...
                                        <input type="tel" value="{{ old('zip_code') }}"
                                ...
                                <div class="form-row ">
                                    <div class="form-group   col-md-12 ">
                                        ...
                                        <select name="listing_options" value="{{ old('listing_options') }}"
                                ...
                                <div class="row">
                                    <div class="form-group   col-md-12  ">
                                        ...
                                        <input type="text" value="{{ old('payment_terms') }}"
